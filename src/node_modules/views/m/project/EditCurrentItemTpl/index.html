<div id="EditCurrentItem" data-vpid="<%-VPID%>" data-vpcon="`{MODURL}`.js">
    <style>
        @@include('main.css')
    </style>
<%-TopBar%>
    <div id="EditCurrentItem_vue">
        <div class="container">
            <h1>您的项目</h1>
            <h4>编辑招标信息</h4>
        ...
        <div class="bg-color">
            <div class="container">
                <div class="choose-panel">
                    ...
                    <div class=" location">
                        <span class="words">环境</span>
                        <p class="show-menu" v-on:click="showLocation()">
                            {{demand.location_name}}
                            <span class="icon-circle-down" v-bind:class="{ rotate: locationClick }"></span>
                        </p>
                        <div class="location-choice" v-if="locationClick" v-on:click="getLocation">
                            <p class="loc-item" v-for="location in Url.locationUrl" v-bind:value="location.id">{{location.name}}</p>
                        </div>
                    </div>
                </div>
                <div class="choose-panel">
        ...
        <div class="container">
            <div class="with-address">
                <span class="words">在哪用屏<span class="must-fill">(必填)</span></span>
                <input type="text" class="input-div size" v-model="demand.address" must="true" placeholder="请填写详细地址（如区域街道等）" maxlength=100  />
            </div>
            <div class="with-size">
                <span class="words">用屏面积<span class="must-fill">(必填)</span></span>
        ...
        <div class="bg-color">
            <div class="container">
                <div class="with-text">
                    ...
                    <textarea class="input-div" v-model="demand.note" placeholder="输入备注 (如工程条件和要求、产品要求、产品品牌要求、工程商要求等）" maxlength=140></textarea>
                </div>
            </div>
        </div>
        <div class="container last-part">
            <div class="with-picture">
                <span class="words up-words">附加施工现场图片、已计划的设计方案</span>
